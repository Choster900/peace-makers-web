                    ...
                    <div class="contact-form-wrap">
                        ...
                        <form action="#">
                            <div class="row g-gs">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="floatingInputPhoneNumber"
                                ...
                                <div class="col-lg-12">
                                    <button class="btn btn-dark" type="submit">{{ SectionData.contactData.btnText
                                    }}</button>
                                </div><!-- end col -->
                            </div><!-- end row -->
                        </form>
                ...
                <div class="col-lg-5">
                    <div class="contact-info ps-lg-4 ps-xl-5">
                        ...
                        <ul class="contact-details">
                            <li class="d-flex align-items-center" v-for="list in SectionData.contactData.contactList"
                                :key="list.id">
