<template>
    <swiper :modules="modules" :slides-per-view="3" :breakpoints="{
        0: {
            slidesPerView: 1
        },
        767: {
        ...
        <swiper-slide v-for="item in SectionData.blogData.blogList" :key="item.id">
            <div class="card card-full card-blog">
                <DropdownLink :to="item.btnLink" class="d-block card-image">
                    <img :src="item.img" class="card-img-top" alt="">
                    <div class="bg-dark-transparent card-overlay">
                        <div class="d-flex align-items-center card-author">
                            <div class="flex-shrink-0 avatar avatar-2"></div>
                            <img src="../../../images/thumb/blog-img.jpg" alt="" class="rounded-circle">
                ...
                <div class="card-body card-body-s1">
                    <h4 class="card-title mb-3"><DropdownLink :to="item.btnLink">{{ item.title }}</DropdownLink></h4>
