<template>
    <section class="brand-section section-space " :class="isBg">
        <div class="container">
            <!-- section heading -->
            <SectionHeading classname="text-center" :text="SectionData.brandData.title"
                :content="SectionData.brandData.content" isMargin="mb-3"></SectionHeading>
            <div class="row g-gs">
                <div class="col-6 col-md-3 col-sm-4" v-for="item in SectionData.brandData.brandList" :key="item.id">
                    <div class="client-logo-item text-center flex justify-center items-center">
